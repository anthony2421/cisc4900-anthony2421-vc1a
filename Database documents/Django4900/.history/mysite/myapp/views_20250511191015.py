...
#    if schools.exists():
#        if school_name == "King's County":
#            template_name = "King's County.html"
#        elif school_name == "Bronx County":
#            template_name = "Bronx County.html"
#       else:
#            template_name = "default_school_template.html"
#        return render(request, template_name, {"school": schools})
#    else:
