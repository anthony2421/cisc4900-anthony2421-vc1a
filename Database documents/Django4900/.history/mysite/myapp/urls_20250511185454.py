...
urlpatterns = [
    ...
    path("county/<str:county_name>/", views.searchCounty, name = "searchCounty"),
    path("county/schools/<str:school_name>/", views.searchSchool, name = "searchSchool"),
    path("county/schools(admin)", views.schools, name = "list2"),
    path("county/school/pathways(admin)", views.pathways, name=  "list3"),
    path("county/school/Brooklyn College", views.brooklynCollege, name = "Brooklyn College")
]